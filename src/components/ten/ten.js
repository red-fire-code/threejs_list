...
import vertexShader from '../../shader/ten_raw/vertexShader.js'
import fragmentShader from '../../shader/ten_raw/fragmentShader.js'
// import vertexShader from '../../shader/ten_shader/vertexShader.js'
// import fragmentShader from '../../shader/ten_shader/fragmentShader.js'
export class Ten extends Component {
  ...
  initThree() {
    ...
    function initRender() {
      ...
      document.getElementById('ten-box').appendChild(renderer.domElement)
  ...
  render() {
    return (
      <div className='ten'>
        <div className='ten-box' id='ten-box'></div>
      </div>
    )
  }
}
